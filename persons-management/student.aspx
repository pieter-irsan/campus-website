<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="student.aspx.cs" Inherits="persons_management.student" %>
        ...
        <form id="formStudent" runat="server">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-12">
                    ...
                    <asp:TextBox CssClass="form-control" ID="txtSchoolOrigin" runat="server"></asp:TextBox>
                </div>
                <div class="col-md-4 col-sm-12">
                    <label>Major</label>
                    <asp:TextBox CssClass="form-control" ID="txtMajor" runat="server"></asp:TextBox>
                </div>
            </div>
            <br />
            <div class="row">
            ...
            <div class="row">
                ...
                <div style="margin:auto;">
                    <asp:GridView ID="tblStudent" CssClass="table table-responsive table-bordered table-hover" runat="server"
                        ...
                        OnRowCommand="tblStudent_RowCommand"
                        OnRowDeleting="tblStudent_RowDeleting">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Update">
                                <ItemTemplate>
                                    <asp:ImageButton ID="btnUpdate" runat="server" CommandName="update" CommandArgument='<%#Eval("StudentID") %>' ImageUrl="~/App_Theme/images/edit.png" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Delete">
                                <ItemTemplate>
                                    <asp:ImageButton ID="btnDelete" runat="server" CommandName="delete" CommandArgument='<%#Eval("StudentID") %>' ImageUrl="~/App_Theme/images/trash.png" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </asp:GridView>
